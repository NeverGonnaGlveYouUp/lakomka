...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        jPerson.setOGRN("9663808710204");
        jPerson.setEdoDate(new Date());
        jPerson.setAddressDelivery("г. Санкт-Петербург, ул. Невский пр., д. 45, лит. А.");
        jPerson.setEmail("random.user123@gmail.com");
        jPerson.setPhone("+7 (905) 678-90-12");
        jPerson.setMapDelivery("mapDelivery");
        jPerson.setPost("Менеджер по продажам");
        ...
        jPerson2.setINN("3389069221");
        jPerson2.setBasePrice(BasePrice.OPT1);
        jPerson2.setKPP("052180608");
        jPerson2.setOGRN("6297040139951");
        jPerson2.setEdoDate(new Date());
        jPerson2.setAddressDelivery("г. Москва, ул. Тверская, д. 12, кв. 34.");
        jPerson2.setEmail("example1@mail.com");
        jPerson2.setPhone("+7 (912) 345-67-89");
        jPerson2.setMapDelivery("mapDelivery2");
        jPerson2.setPost("Главный бухгалтер");
